...
models = {
    'diabetes': pickle.load(open('Datasets/diabetes_data.csv', 'rb')),
    'heart_disease': pickle.load(open('Datasets/heart_disease_data.csv', 'rb')),
    'parkinsons': pickle.load(open('Datasets/parkinsons_data.csv', 'rb')),
