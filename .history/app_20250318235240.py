...
models = {
    'diabetes': pickle.load(open('Datasets/diabetes_model.sav', 'rb')),
    'heart_disease': pickle.load(open('Datasets/heart_disease_model.sav', 'rb')),
    'parkinsons': pickle.load(open('Datasets/parkinsons_model.sav', 'rb')),
    'lung_cancer': pickle.load(open('Datasets/lungs_disease_model.sav', 'rb')),
    'thyroid': pickle.load(open('Datasets/Thyroid_model.sav', 'rb'))
}
